...
Olhando para estas expressões de realidade podemos encontrar linguagens e níveis de resolução diversos, compete-nos como intérpretes privilegiados usar a nossa inteligência, intuição e sensibilidade para as reconhecer chamando a nós a responsabilidade pela construção atendendo ás várias dimensões, descontinuidades perceptivas e duvidando do retrato psíquico que fazemos.
